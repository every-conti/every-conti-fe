...
export default function ContiCopyModal({
   isOpen,
   onClose,
   conti,
}: ContiCopyModalProps) {
    ...
    const [description, setDescription] = useState(`${conti?.creator.nickname}의 "${conti?.title}" 콘티를 복사했습니다.`);
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <RadioGroup value={copyMode} onValueChange={(value: "new" | "existing") => setCopyMode(value)}>
                    ...
                    {/* 복사될 곡 목록 미리보기 */}
                    <div className="space-y-2">
                        <Label className="text-sm text-gray-600">복사될 곡 목록 ({conti?.songs.length}곡)</Label>
                            ...
                            {conti?.songs.map((song, index) => (
                                <div key={song.song.id} className="flex items-center justify-between text-sm">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-xs text-gray-500">{parseSongDuration(song.song.duration)}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="flex justify-end space-x-3 pt-4 border-t">
                        ...
                        <Button
                            ...
                            disabled={(copyMode === "existing" && contis.length === 0) ||
