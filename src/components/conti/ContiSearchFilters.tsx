...
import { Search, Filter, X, ChevronDown, ChevronUp, Clock, Users, Music, User } from "lucide-react";
...
export default function ContiSearchFilters({
  ...
  const [durationChanging, setDurationChanging] = useState<[number, number]>([
    MIN_TOTAL_DURATION,
    MAX_TOTAL_DURATION,
  ]);
