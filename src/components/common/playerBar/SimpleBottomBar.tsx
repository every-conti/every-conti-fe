...
import {Heart, Music, Pause, Play, Plus, Shuffle, SkipBack, SkipForward, Volume2, X} from "lucide-react";
            ...
            <div className="fixed bottom-4 left-4 right-4 z-50 max-w-[1100px] mx-auto" ref={setBarRef}>
                <div className="bg-white border-t border-gray-200 shadow-lg rounded-2xl overflow-hidden">
                    ...
                    <div className="sm:hidden bg-white border-t border-gray-200 shadow-lg px-3 py-2">
                        ...
                        <div className="flex items-center space-x-3 flex-1 min-w-0" onClick={() => setIsFullScreen(true)}>
                            {/* 왼쪽: 제목/팀명만 */}
                            <div className="min-w-0 flex-1 leading-tight">
                                <div className="text-sm font-medium text-gray-900 truncate">{currentSong.songName}</div>
                                <div className="text-[11px] text-gray-600 truncate">{currentSong.praiseTeam.praiseTeamName}</div>
                            </div>
