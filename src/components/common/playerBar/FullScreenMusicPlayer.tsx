...
}: { song: any; index: number; isActive: boolean; isPlaying: boolean }) {
    return (
        <div
        ...
        >
            <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-md overflow-hidden flex-shrink-0">
                <div className="relative w-12 h-12 rounded-md overflow-hidden flex-shrink-0">
                    <ImageWithFallback src={song.thumbnail} alt={song.songName} className="w-full h-full object-cover" />
                    {isActive && isPlaying && (
                        ...
                        <div className="w-full max-w-6xl mx-auto min-h-0 flex flex-col items-center justify-center gap-6 lg:gap-8">
                            ...
                            <div className="flex flex-col items-center w-full max-w-full">
                                    ...
                                    {isPlaying && (
                                        <div className="absolute bottom-4 right-4">
                                            <div className="flex space-x-1">
                                                ...
                                                <div className="w-1 h-4 bg-white/80 rounded animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                                                <div className="w-1 h-4 bg-white/80 rounded animate-pulse" style={{ animationDelay: "0.4s" }}></div>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="flex items-center gap-4 w-full max-w-full justify-center">
                                    <Button variant="ghost" size="icon" onClick={handleLike} className="text-white hover:bg-white/20">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Volume2 className="w-4 h-4 text-gray-300" onClick={() => setState((prev) => ({ ...prev, volume: 0 }))} />
                                        <Slider
