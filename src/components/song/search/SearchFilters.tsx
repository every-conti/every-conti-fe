...
import { MAX_SONG_DURATION, MIN_SONG_DURATION } from "src/constant/conti/conti-search.constant";
            ...
            {selectedThemes &&
              ...
              selectedThemes.map((theme) => (
                <Badge
                  ...
                  onClick={() => setSelectedThemes(selectedThemes.filter((t) => t.id !== theme.id))}
                >
                  테마: {theme.themeName}
                  <X className="w-3 h-3" />
                </Badge>
