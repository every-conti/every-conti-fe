...
import { ArrowLeft, Play, Pause, Clock, Music, Calendar, Share2, Copy } from "lucide-react";
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-80 flex-shrink-0">
              <div className="aspect-square w-full max-w-80 mx-auto lg:mx-0 relative overflow-hidden rounded-xl">
                <ImageWithFallback
            ...
            <div className="flex-1">
              ...
              {songs.length > 0 && (
                <div className="flex flex-wrap items-center gap-3">
                  <Button onClick={handlePlayAll} className="bg-blue-600 hover:bg-blue-700">
                    ...
                    <div className="w-8 flex justify-center mr-4">
                      {isCurrentSongPlaying(song.song) ? (
                        <div className="flex space-x-0.5">
                          ...
                          <div
                            className="w-1 h-3 bg-blue-600 rounded animate-pulse"
