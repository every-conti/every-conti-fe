...
import { Search, GripVertical, Trash2, Calendar, Save } from "lucide-react";
...
function ContiCreationPage() {
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, isError } =
    useInfiniteSearchSongQuery({ text: q || undefined, enabled: q.length > 0 });
        ...
        <div className="space-y-4 sm:space-y-6">
          <Card className="p-4 sm:p-6 gap-y-2 sm:gap-y-4 gap-x-0">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                <Label htmlFor="title" className="mb-1.5 sm:mb-2 text-sm sm:text-base">
                  콘티 제목
                </Label>
                <Input
                  id="title"
              ...
              <div>
                <Label htmlFor="date" className="mb-1.5 sm:mb-2 text-sm sm:text-base">
                  날짜
                </Label>
          ...
          <Card className="p-4 sm:p-6 gap-y-2 sm:gap-y-4 gap-x-0">
            ...
            <div className="relative flex-1">
              ...
              >
                ...
                <Input
                  placeholder={
                    selectedSongs.length ? "추가로 검색하여 선택…" : "찬양 제목을 검색하세요…"
                  }
              ...
              {songDropdownOpen && (
                ...
                >
                  {isLoading && (
                    <div className="p-3 sm:p-4 text-xs sm:text-sm text-gray-500">검색 중…</div>
                  )}
                  ...
                  {isFetchingNextPage && (
                    <div className="p-3 text-center text-[11px] sm:text-xs text-gray-400">
                      더 불러오는 중…
                    </div>
                  )}
