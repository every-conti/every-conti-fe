...
export const fetchUserChangePassword = async (memberId: string | undefined, changePasswordDto: ChangePasswordDto) => {
    const apiOptions: ApiOptions = {
        method: "PATCH",
        requiresAuth: true,
...
export const fetchUserChangeNickname = async (memberId: string | undefined, nickname: string | undefined) => {
    const apiOptions: ApiOptions = {
        method: "PATCH",
        requiresAuth: true,
        data: nickname
