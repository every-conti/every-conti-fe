...
export const useInfiniteSearchContiQuery = (params: SearchContiQueriesDto, options = {}) => {
  const apiOptions: ApiOptions = {
    useCache: true,
  };
  const keyPart = useMemo(() => buildQueryParams({ ...params, offset: undefined }), [params]);
...
export const fetchContiCreate = async (createContiDto: CreateContiDto) => {
  ...
  const data: ContiSimpleDto = await apiRequestWithRefresh("/conti", apiOptions);
  return data;
};
...
export const fetchContiUpdate = async (contiId: string, updateContiDto: UpdateContiDto) => {
  ...
  const data: ContiSimpleDto = await apiRequestWithRefresh(`/conti/${contiId}`, apiOptions);
  return data;
};
export const fetchContiDelete = async (contiId: string, deleteContiDto: DeleteContiDto) => {
  ...
  const data = await apiRequestWithRefresh(`/conti/${contiId}`, apiOptions);
  return data;
};
...
export const fetchContiDetail = async (contiId: string) => {
  ...
  const data: ContiWithSongDto = await apiRequestWithRefresh(`/conti/${contiId}`, apiOptions);
  return data;
};
...
export const fetchContiCopy = async (copyContiDto: CopyContiDto) => {
  ...
  const res: CommonResponseDto<string> = await apiRequestWithRefresh(`/conti/copy`, apiOptions);
  return res;
};
